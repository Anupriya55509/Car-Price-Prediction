...
#Background Image
img = Image.open(r"D:\Car pricing Prediction\App\car.jpg")
...
btn = Button(root, text="Predict Price",
             ...
             bd=0,
             padx=30, pady=12)
btn.place(relx=0.1, rely=0.8, anchor="w")   # 👈 LEFT ALIGN

#Output
price_label = Label(root, text="₹ 0",
                    bg="#222233", fg="white",
                    font=("Helvetica", 24, "bold"))
price_label.place(relx=0.15, rely=0.9, anchor="w")  # 👈 LEFT ALIGN
